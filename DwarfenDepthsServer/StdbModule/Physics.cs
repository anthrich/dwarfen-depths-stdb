...
{
    public static DbVector2? GetIntersection(Module.Line line1, Module.Line line2)
    {
        var p1 = line1.Start;
        var p2 = line1.End;
        var p3 = line2.Start;
    ...
    public static Module.Line[] GetNearbyLines(Module.Line line1, Module.Line[] allLines)
    {
    ...
    public struct BoundingBox
    {
        ...
        public static BoundingBox FromLine(Module.Line line)
        {
